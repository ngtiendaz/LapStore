...
{
    public partial class taiNgheUserControl : UserControl
    {
        string MADANHMUC = "DM006";
        public taiNgheUserControl()
        {
            InitializeComponent();
        ...
        private void taiNgheUserControl_Load(object sender, EventArgs e)
        {
        ...
        private void taiNgheUserControl_Paint(object sender, PaintEventArgs e)
        {
