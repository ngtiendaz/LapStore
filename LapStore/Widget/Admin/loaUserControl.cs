...
{
    public partial class loaUserControl : UserControl
    {
        string MADANHMUC = "DM008";
        public loaUserControl()
        {
            InitializeComponent();
        ...
        private void loaUserControl_Load(object sender, EventArgs e)
        {
        ...
        private void loaUserControl_Paint(object sender, PaintEventArgs e)
        {
