...
{
    public partial class micUserControl : UserControl
    {
        string MADANHMUC = "DM007";
        public micUserControl()
        {
            InitializeComponent();
        }
        ...
        private void micUserControl_Load(object sender, EventArgs e)
        {
        ...
        private void micUserControl_Paint(object sender, PaintEventArgs e)
        {
