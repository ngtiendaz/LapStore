...
{
    public partial class webCamUserControl : UserControl
    {
        string MADANHMUC = "DM009";
        public webCamUserControl()
        {
            InitializeComponent();
        ...
        private void webCamUserControl_Load(object sender, EventArgs e)
        {
        ...
        private void webCamUserControl_Paint(object sender, PaintEventArgs e)
