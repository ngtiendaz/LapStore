...
{
    public partial class phimUserControl : UserControl
    {
        string MADANHMUC = "DM004";
        public phimUserControl()
        {
            InitializeComponent();
        ...
        private void phimUserControl_Load(object sender, EventArgs e)
        {
        ...
        private void phimUserControl_Paint(object sender, PaintEventArgs e)
        {
