...
{
    public partial class phuKienUserControl : UserControl
    {
        string MADANHMUC = "DM011";
        public phuKienUserControl()
        {
            InitializeComponent();
        ...
        private void phuKienUserControl_Load(object sender, EventArgs e)
        {
        ...
        private void phuKienUserControl_Paint(object sender, PaintEventArgs e)
        {
