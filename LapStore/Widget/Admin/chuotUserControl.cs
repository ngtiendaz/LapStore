...
{
    public partial class chuotUserControl : UserControl
    {
        string MADANHMUC = "DM005";
        public chuotUserControl()
        {
            InitializeComponent();
        ...
        private void chuotUserControl_Load(object sender, EventArgs e)
        {
        ...
        private void chuotUserControl_Paint(object sender, PaintEventArgs e)
        {
