...
CREATE TABLE MAGIAMGIA (
    id CHAR(10) PRIMARY KEY,
    tenMa NVARCHAR(50) UNIQUE,       -- Tên mã (vd: GIAM10)
    phanTramGiam INT CHECK (phanTramGiam > 0 AND phanTramGiam <= 100),  -- Giảm theo %
    soLuong INT,                     -- Số lượng mã có thể sử dụng
    ngayBatDau DATETIME,
...
INSERT INTO SANPHAM (maSp, maDm, maHang, tenSp, hinhAnh, moTa, giaNhap, giaBan, soLuong)
VALUES 
('SP001', 'DM001','H002', N'Laptop Asus Gaming TUF FX507VU-LP315W (Geforce RTX4050 6GB/i7 13620H/16GB RAM/512GB SSD/15.6 FHD 144hz/Win11/Xám)', 'D:\DataC#\image\84717_laptop_asus_gaming_tuf_fx507vu_lp315w__3_.jpg', N'Bộ vi xử lý: Intel Core i7-13620H
...
('SP002', 'DM001','H002', N'Asus Vivobook 14 OLED A1405VA-KM095W (i5 13500H/16GB RAM/512GB SSD/14 2.8K Oled/Win11/Bạc/Chuột)', 'D:\DataC#\image\71159_ltau870.png', N'CPU: Intel Core i5-13500H (upto 4.7GHz, 18MB)
...
('SP004', 'DM001','H004', N'Laptop Dell Inspiron 3520 (25P2312) (i5 1235U 16GB RAM/512GB SSD/15.6 inch FHD 120Hz/Win11/OfficeHS21/Bạc)', 'D:\DataC#\image\75901_laptop_dell_inspiron_3520__i5_1135g7_8gb_ram512gb_ssd15_6_inch_fhd_120hzubuntub___c___2_.jpg', N'CPU: Intel® Core™ i5 1235U
...
INSERT INTO SANPHAM (maSp, maDm, maHang, tenSp, hinhAnh, moTa, giaNhap, giaBan, soLuong)
VALUES 
('SP012', 'DM002','H007', N'Màn hình LG UltraGear 27GS65F-B (27 inch/FHD/IPS/180Hz/1ms)', 'D:\DataC#\image\mh1.jpg', N'Kích thước: 27 inch
...
('SP013', 'DM003','H007', N'PC HACOM AI ULTRA MAX ( CORE ULTRA 285K / VGA RTX 5090 AORUS MASTER / GAMING GEAR/ MONITOR OLED 45" CURVED 240 HZ )', 'D:\DataC#\image\pc1.jpg', N'CPU : Intel CORE ULTRA 285K
MAIN : Z890
RAM : 96GB ( 2x48) DDR5
SSD : 4TB
VGA: NVIDIA RTX 5090
NGUỒN : 1600W
Màn hình LG OLED 45GS95QE-B', 200000000, 249999999, 0),

('SP014', 'DM005','H007', N'Chuột Logitech B100 Black (910-006605) (USB)', 'D:\DataC#\image\chuot1.jpg', N'Chuột Logitech B100
Độ phân giải 800dpi
Kết nối USB
Thiết kế đối xứng, gọn nhẹ
Phù hợp với nhu cầu văn phòng, giải trí nhẹ', 70000, 79000, 15),

('SP015', 'DM006','H007', N'Tai nghe không dây Logitech G535 Lightspeed wireless Black', 'D:\DataC#\image\tainghe1.jpg', N'Tai nghe không dây Logitech G535 Lightspeed
...
('SP016', 'DM007', 'H007',N'Microphone ASUS ROG Carnyx Black', 'D:\DataC#\image\mic1.jpg', N'Mang đến âm thanh thực sự phong phú và ấm áp
...
('SP017', 'DM004', 'H007',N'Bàn phím Corsair K100 RGB Optical switch (OPX-RF) (CH-912A01A-NA)', 'D:\DataC#\image\phim1.jpg', N'Bàn phím Corsair K100 RGB
...
('SP018', 'DM008','H007', N'Loa di động JBL CHARGE 5 - Màu xanh dương', 'D:\DataC#\image\loa1.jpg', N'Thời lượng pin: 20 giờ
Thời gian sạc: 4 giờ
Cổng sạc: Type C
Công suất: 40W
...
('SP019', 'DM009','H007', N'Webcam hội nghị truyền hình Logitech Meetup', 'D:\DataC#\image\web1.png', N'Camera hội nghị với tầm quan sát 120 độ và công nghệ quang học 4K
...
('SP020', 'DM010','H007', N'Máy Chơi Game Sony Playstation 5 (PS5) Slim Console – 30th Anniversary Limited Edition', 'D:\DataC#\image\game1.jpg', N'Máy Chơi Game Sony Playstation 5 (PS5) Slim Console – 30th Anniversary Limited Edition
...
('SP021', 'DM011','H007', N'Fan Case Tản Nhiệt NZXT F120RGB Duo Black(Triple)', 'D:\DataC#\image\pk1.jpg', N'Anh sáng RGB rực rỡ từ mọi góc độ với 20 đèn LED có thể tùy chỉnh
